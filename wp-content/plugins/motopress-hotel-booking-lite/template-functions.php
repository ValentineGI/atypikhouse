...
function mphb_tmpl_the_loop_room_type_book_button( $buttonText = null ){
	...
	echo '<a class="button mphb-book-button" href="' . esc_url( get_the_permalink() ) . '#booking-form-' . get_the_ID() . '">' . esc_html( $buttonText ) . '</a>';
}
...
function mphb_tmpl_the_loop_room_type_book_button_form( $buttonText = null ){
	...
	echo '<button type="submit" class="button mphb-book-button" >' . esc_html( $buttonText ) . '</button>';
	echo '</form>';
}
...
function mphb_tmpl_the_loop_room_type_view_details_button( $buttonText = null ){
	...
	echo '<a class="button mphb-view-details-button" href="' . esc_url( get_the_permalink() ) . '" >' . esc_html( $buttonText ) . '</a>';
}
