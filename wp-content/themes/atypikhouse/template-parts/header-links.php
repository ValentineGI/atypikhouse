<ul class="header-links">
    <li class="header-links_item">
        <a href="<?php echo esc_url( get_page_link( 283 ) ); ?>" target="<?php echo get_search_query(); ?>" title="<?php _e("Recherche", 'atypikhouse'); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
        </a>
    </li>
    <li class="header-links_item">
        <a href="#" target="#" title="<?php _e("Language", 'atypikhouse'); ?>">
    ...
    <li class="header-links_item">
        <a href="<?php echo esc_url( get_page_link( 283 ) ); ?>" target="#" title="<?php _e("User", 'atypikhouse'); ?>">
